...
func (c *lockServiceClient) RequestLock(ctx context.Context, in *LockRequest, opts ...grpc.CallOption) (*LockResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lockutility.LockService/RequestLock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lockServiceClient) ReleaseLock(ctx context.Context, in *ReleaseRequest, opts ...grpc.CallOption) (*ReleaseResponse, error) {
	out := new(ReleaseResponse)
	err := c.cc.Invoke(ctx, "/lockutility.LockService/ReleaseLock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LockService_RequestLock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lockutility.LockService/RequestLock",
	}
...
func _LockService_ReleaseLock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lockutility.LockService/ReleaseLock",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LockServiceServer).ReleaseLock(ctx, req.(*ReleaseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LockService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "lockutility.LockService",
	...
	Metadata: "internal/lockserver/lockserver.proto",
}
